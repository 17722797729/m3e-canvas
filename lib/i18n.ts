...
export const KO: Record<UIKey, string> = {
  ...
  ruleWhen: "조건", ruleThen: "실행", ruleGoto: "이동", ruleBack: "뒤로", ruleClose: "오버레이 닫기", ruleLook: "모양 바꾸기", ruleAfter: "N초 뒤 자동 실행", flowStay: "모양 그대로", lookTarget: "바꿀 대상", lookText: "텍스트", lookColor: "사용자 지정 색", lookSelf: "이 부품", actionKeep: "그대로 두기", propColor: "색", propChecked: "켜짐/꺼짐", propSelected: "선택된 항목", propValue: "값", valueMinus: "1 줄이기", valueOpSet: "값 설정", valueOpAdd: "더하기", valueOpSub: "빼기", valueStep: "단계", valuePlus: "1 늘리기", boolYes: "켜기", showsValue: "값 표시", showsUnit: "％ 표시", showsUnitHint: "끄면 슬라이더의 숫자에서 ％가 사라집니다. 값을 읽는 텍스트는 항상 숫자만 받습니다.", mixOwn: "자기 글자와 함께", mixHint: "자기 글자 안의 {v} 자리에 숫자가 들어갑니다. 쓰지 않으면 끝에 붙습니다.", mixInsert: "끝에 {v} 넣기", maxValue: "최댓값", maxHint: "값·드래그·＋／−의 상한입니다. 비우면 {n}.", showsNothing: "자기 글자", showsPickHint: "슬라이더나 바를 고르면 이 텍스트가 그 현재 값을 표시합니다.", ruleStayHint: "이 선의 동작은 다른 부품만 바꿉니다. 모양을 그대로 두면 누를 때마다 적용됩니다.", showsHint: "이 텍스트는 자기 글자 대신 고른 부품의 현재 값을 표시합니다. 슬라이더를 움직이면 숫자도 함께 움직입니다.", boolNo: "끄기", flowAddProp: "바꿀 속성 추가", actionShow: "표시", actionHide: "숨기기", ruleCheckHint: "슬롯 그리드의 체크박스 표시를 켜고 끕니다. 게임의 선택 버튼처럼 프레임 밖 버튼으로 일괄 선택 모드를 열고 닫을 수 있으며, 체크는 보는 사람이 셀을 탭해 채웁니다.", ruleLookHint: "이 단계가 여기서 정한 모양으로 바꾸고 그대로 둡니다(되돌리려면 되돌리는 단계를 더하세요).", ruleAfterShort: "N초 후",
