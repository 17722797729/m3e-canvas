...
export const KO: Record<UIKey, string> = {
  ...
  ruleWhen: "조건", ruleThen: "실행", ruleGoto: "이동", ruleBack: "뒤로", ruleClose: "오버레이 닫기", ruleLook: "모양 바꾸기", ruleAfter: "N초 뒤 자동 실행", lookTarget: "바꿀 대상", lookText: "텍스트", lookColor: "사용자 지정 색", lookSelf: "이 부품", ruleLookHint: "이 단계가 여기서 정한 모양으로 바꾸고 그대로 둡니다(되돌리려면 되돌리는 단계를 더하세요).", ruleAfterShort: "N초 후",
