...
export const UI = {
  ...
  addRule: { ja: "ルールを追加", en: "Add a rule", zh: "添加规则" },
  removeRule: { ja: "ルールを削除", en: "Remove the rule", zh: "删除规则" },
  cooldownSeconds: { ja: "クールダウン（秒）", en: "Cooldown (seconds)", zh: "冷却时间（秒）" },
  state_disable: { ja: "灰色にして反応しなくする", en: "Grey out and stop responding", zh: "置灰并停止响应" },
  state_cooldown: { ja: "灰色にしてカウントダウンする", en: "Grey out and count down", zh: "置灰并倒计时" },
