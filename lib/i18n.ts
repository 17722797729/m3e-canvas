...
> = {
  ja: {
    ...
    sliderInput: { noun: "スライダー入力", label: "音量" },
  ...
  en: {
    ...
    sliderInput: { noun: "slider field", label: "Volume" },
  ...
  zh: {
    ...
    sliderInput: { noun: "多功能滑块", label: "音量" },
  ...
  ko: {
    ...
    sliderInput: { noun: "슬라이더 입력", label: "볼륨" },
