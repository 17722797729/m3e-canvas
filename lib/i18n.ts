...
export const KO: Record<UIKey, string> = {
  ...
  createContainer: "컨테이너 만들기", putInContainer: "컨테이너에 넣기", children: "안에 부품 {n}개", insideContainer: "컨테이너 안에 있음", releaseChildren: "안의 부품 꺼내기", takeOut: "컨테이너에서 꺼내기",
  ...
  composites: "조합 부품", composite: "조합", composeNew: "사용자 지정(조합 만들기)", composeHint: "아래 부품을 탭해 추가하고 끌어서 배치하세요. 다 되면 '조합 완료'를 누르면 왼쪽 목록에 들어갑니다.", compositeName: "조합 이름", composeEmpty: "아래에서 부품을 골라 조합을 만드세요", composeDone: "조합 완료", bringForward: "앞으로", sendBackward: "뒤로", editComposite: "조합 편집", resizePart: "끌어서 크기 조절", deleteComposite: "조합 삭제",
